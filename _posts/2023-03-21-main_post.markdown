...
<p align = "center">
<b>Figure 2: Time series plot of drug/narcotic related crimes in San Francisco from 2003 to 2017 categorized by drug type.</b>
</p>
...
In this analysis we have highlighted some trends in drug/narcotic crimes in San Francisco and found some interesting articles and sites that explain these trends. There is definitely more interesting analysis that could be done, but we cannot include in this assignment. One idea is to look into the number of drug crimes by crime type in each district to see if there are any differences in which drugs are mostly used by districts.